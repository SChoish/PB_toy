...
from agents.pathbridger.critic import ScalarValueNet
from agents.pathbridger.utils.flax_utils import ModuleDict, TrainState, nonpytree_field
from agents.pathbridger.utils.dynamics import (
    forward_bridge_coefficients,
    make_dynamics_schedule,
)
from agents.pathbridger.utils.goal_representation import assert_phi_goal_obs_indices, goal_representation, normalize_phi_goal_obs_indices
from agents.pathbridger.utils.networks import MLP
...
class DynamicsAgent(_DynamicsAgentCore):
    ...
    def _total_loss_forward_bridge(self, batch, grad_params, rng, critic_value_params):
        ...
        info = {
            ...
            'phase1/loss_path_step': first_step_l1_fb_norm if path_loss_normalized else first_step_l1_fb,
